...
import com.yaouguoji.platform.constant.RedisKeys;
import com.yaouguoji.platform.service.RedisClientService;
...
//        return 0;
    ...
    public int verifyCode(String phoneNum, String code) {
        ...
        redisClientService.remove(RedisKeys.SHOP_VERIFY_CODE + phoneNum);
        return 1;
    }
